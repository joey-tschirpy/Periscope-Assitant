...
public class ObjImporter {
	...
	public static GameObject Import(string objString, string mtlString, Hashtable textures, Quaternion rotate, Vector3 scale, Vector3 translate, bool gameObjectPerGroup = true, bool subMeshPerGroup = true, bool usesRightHandedCoordinates = false) {
	...
	public static GameObject Import(string objString, Quaternion rotate, Vector3 scale, Vector3 translate, string mtlString, Texture2D[] textures, bool gameObjectPerGroup = true, bool subMeshPerGroup = true, bool usesRightHandedCoordinates = false) {
		List<Hashtable> geometries = ImportGeometry(objString, gameObjectPerGroup, subMeshPerGroup);
	...
	public static IEnumerator ImportInBackground(string objString, string mtlString, Hashtable textures, System.Action<GameObject> result, bool gameObjectPerGroup = true, bool subMeshPerGroup = true, bool usesRightHandedCoordinates = false) {
		yield return null;
